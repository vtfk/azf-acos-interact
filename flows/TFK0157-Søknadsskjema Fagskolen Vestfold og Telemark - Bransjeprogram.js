...
const description = 'Søknadsskjema Fagskolen Vestfold og Telemark - Bransjeprogram'
module.exports = {
  config: {
    enabled: true,
  ...
  statistics: {
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          company: 'Fagskolen',
          department: 'Bransjeprogram', // denne er antakelig feil :-)
          description, // Required. A description of what the statistic element represents
          type: 'søknad' // Required. A short searchable type-name that distinguishes the statistic element
        }
      }
    }
  },
